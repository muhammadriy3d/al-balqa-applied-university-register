    ...
    <>
      <div className="z-10 max-w-[1680px] mx-auto dark:bg-slate-800 bg-white bg-opacity-80 xl:drop-shadow-none backdrop-blur flex justify-between px-4 max-[386px]:px-2 xl:px-0 xl:py-2 items-center w-full min-h-[50px]  select-none">
        <a className="flex justify-center items-center cursor-pointer dark:text-white text-slate-800 hover:text-slate-900">
          ...
          <h1 className="flex flex-col font-bold max-[410px]:px-2 max-[410px]:text-sm text-lg px-4 font-['AlJazeeraFontBold']">جامعة البلقاء التطبيقية<span className="text-[.8em] font-serif tracking-wide">Al-Balqa Applied University</span></h1>
        </a>
        <div className="flex">
      ...
      <nav
        className={`max-w-[1680px] mx-auto w-full xl:opacity-100 xl:top-0 xl:relative xl:scale-y-100 transition-all duration-500 ease-in-out ${clicked ? 'opacity-100 relative top-0' : 'opacity-30 absolute scale-y-0 top-[-100%] right-0 left-0'
